  ...
  return (
    ...
    >
      ...
      <nav className="relative z-30 mt-8 flex flex-wrap gap-x-4 gap-y-2 text-[13px] font-bold uppercase leading-[1] md:absolute md:bottom-3 md:left-3 md:mt-0 md:flex-col md:gap-y-1 md:text-[12px] md:bottom-4 md:left-4">
        <Link href="/" className="px-1 py-1.5 hover:text-[#f2f2ee] md:px-0 md:py-0">
          Home
        </Link>
        <Link href="/projects" className="px-1 py-1.5 hover:text-[#f2f2ee] md:px-0 md:py-0">
          Projects
        </Link>
        <Link href="/about" className="px-1 py-1.5 hover:text-[#f2f2ee] md:px-0 md:py-0">
          About
        </Link>
        <a
          ...
          className="px-1 py-1.5 hover:text-[#f2f2ee] md:px-0 md:py-0"
        >
          LinkedIn
        </a>
        <a
